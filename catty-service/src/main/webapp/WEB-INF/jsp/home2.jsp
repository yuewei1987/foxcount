...
<div id="app" v-loading="appLoading">
    ...
    <div class="top-area">
        ...
        <div class="two-btn">
            ...
            <el-button type="text" class="grey-link link-view-expenses">View Expenses</el-button>
        </div>
        <!-- end .right-area -->
    </div>
    <!-- .top-area -->
            ...
            <ul>
                <li v-for="row in addExpensesData">
                    <div class="img-boxs link-view-expenses" v-on:click="addExpensesClose">
                        <el-tooltip class="item" effect="dark" v-bind:content="row.price" placement="top">
                            <div class="img-wrapper">
                                <img v-bind:src=row.serviceurl alt="pic" class="img"/>
                                <sup class="el-badge__content is-fixed">{{row.number}}</sup>
                            </div>
                        </el-tooltip>
                        <!-- end el-tooltip -->
                    </div>
    ...
    <aside class="aside expenses hide">
        <div class="heading">
            <h3 class="description">Add and edit expenses</h3>
        ...
        <div class="nav-bar clearfix">
            ...
            <!-- end .nav-bar-right -->
            <div class="nav-boxs">
                <a href="javascript:;" class="nav-item new-nav-item active">New({{newExpensesDataLength}})</a>
            ...
            <div class="news-expenses">
                            ...
                            <template scope="scope">
                                <div class="list-item list-item-info clearfix">
                                    ...
                                    <div class="left-area">
                                        ...
                                        <div class="txt-area">
                                            <span class="title">{{scope.row.title}}</span>
                                            <span class="little-grey-txt date">{{scope.row.date}}</span>
                ...
                <div class="bottom-bar">
                    ...
                    <el-pagination
                            ...
                            v-bind:total=newExpensesDataLength>
                    </el-pagination>
                </div>
                <!-- end .bottom-bar -->
            </div>
    ...
    <aside class="aside view-expense hide">
        ...
        <div class="table-data no-nav">
            <el-table
                ...
                <el-table-column
                        width="448">
                    <template scope="scope">
                        <div class="list-item link-view-webflow clearfix">
                            <div class="left-area">
                                <div class="img-boxs">
                                    <img v-bind:src=scope.row.serviceurl alt="pic" class="img"/>
                                </div>
                                <div class="txt-area">
                                    <span class="title">{{scope.row.title}}</span>
                                    <span class="grey-txt date">{{scope.row.date}}</span>
                                </div>
                                <!-- end .txt-area -->
                            </div>
                            <!-- end .color-point-block -->
        ...
        <div class="bottom-bar">
            <el-pagination
                    v-bind:page-size=viewExpensesPageSize
                    @current-change="handleCurrentViewChange"
                    layout="prev, pager, next"
                    v-bind:total=tempviewExpensesData.length>
            </el-pagination>
        </div>
        <!-- end .bottom-bar -->
    </aside>
    ...
    <aside class="aside sub-list expense-detail hide" v-loading="loading">
        <div class="list-item clearfix">
            <div class="left-area">
                <div class="img-boxs">
                    <img src="i/w-pic.png" alt="pic" class="img"/>
                </div>
                <div class="txt-area">
                    <span class="title">Webflow</span>
                    <span class="grey-txt">Webflow.com</span>
                </div>
                <!-- end .txt-area -->
            </div>
            <!-- end .left-area -->
                    ...
                    <template scope="scope">
                        <div class="list-item list-item-info clearfix click-area" data-toggle="modal"
                            ...
                            <div class="left-area">
                                ...
                                <div class="txt-area">
                                    <span class="title">{{scope.row.title}}</span>
                                    <span class="little-grey-txt">{{scope.row.date}}</span>
    ...
    var Main = {
        data() {
            return {
                ...
                newExpensesData: [],
                newTempExpensesData: [],
                newExpensesDataPageSize: 5,
                newExpensesDataPageNum: 1,
                newExpensesDataLength: 0,
                addExpensesData: [],
                addTempExpensesData: [],
                addExpensesDataPageSize: 5,
            ...
            filteredInvoices: function () {
                ...
                return self.invoicesData.filter(function (invoicesData) {
                    return (invoicesData.title.indexOf(servicename) !== -1)
                })
            },
        ...
        methods: {
            ...
            loadNewExpense: function () {
                vm.$data.newExpensesData = [];
                var page = vm.$data.newExpensesDataPageNum;
                var pagesize = vm.$data.newExpensesDataPageSize;
                $.ajax({
                    url: "/expense/getListByPage?pid=" + vm.$data.currentProjectId + "&pageNum=" + page + "&pageSize=" + pagesize + "&status=0",
                    type: "get",
                    contentType: "application/json",
                    async: false,
                    //返回数据的格式
                    ...
                    success: function (result) {
                        ...
                        vm.$data.newExpensesDataLength = result.total;
...
//                                                    addexpense[ad].price = addexpense[ad].price + data[i].cost;
            ...
            mailchange: function () {
                vm.$nextTick(function () {
                    if (vm.$data.gmailvalue == 0) {
                        //TODO
                        var url = "https://accounts.google.com/o/oauth2/auth?scope=https://mail.google.com/+https://www.googleapis.com/auth/userinfo.email&redirect_uri=" +
                            "http://localhost/google/oauth2callback&response_type=code" +
...
//                    datatype: "json",
//                    success:function(data){
//                        console.dir(data.projectname);
//						vm.$data.inputProjectName=data.projectname;
//						vm.$data.currencyvalue = data.curreency;
//                    },
//                    error:function(e){
//                        console.log("project load error.."+e);
//                    }
